...
export class CustomerService {
  ...
  private customersUrl = 'http://demoapi-env.eba-ydmm2htc.us-east-1.elasticbeanstalk.com/api/customers';  // URL to web api
  ...
  deleteCustomer(id: number): Observable<Customer> {
    ...
    return this.http.post<Customer>(url, this.httpOptions).pipe(
